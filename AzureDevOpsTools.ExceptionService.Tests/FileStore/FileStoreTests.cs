...
//namespace AzureDevOpsTools.Exception.Tests.FileStore
//{
...
//            for (var i = 0; i < 10; i++)
//            {
//                var ex = new AzureDevOpsTools.ExceptionService.Common.ExceptionEntity()
//                             {
//                                 ApplicationName =
...
//                                 ExceptionClass = ExceptionTestConstants.RndStrLength(10),
//                                ExceptionMethod = ExceptionTestConstants.RndStrLength(10),
//                                ExceptionSource = ExceptionTestConstants.RndStrLength(10),
//                                 Username = ExceptionTestConstants.RndStrLength(10),
//                                 Version = ExceptionTestConstants.RndStrLength(10)
//                             };

//                new FileStore.FileStore().SaveException(ex);
//            }
...
//            ex = new AzureDevOpsTools.ExceptionService.Common.ExceptionEntity()
//            {
//                ApplicationName = ExceptionTestConstants.RndStrLength(1000) + "<?xml version_" + ExceptionTestConstants.RndStrLength(10),
//                ChangeSet = ExceptionTestConstants.RndStrLength(1000),
//                Comment = ExceptionTestConstants.RndStrLength(1000),
